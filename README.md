...
Скачиваем скрипт, делаем файл исполняемым и запускаем установку:
    ...
    curl -sSL https://raw.githubusercontent.com/asadullinam/vps_install/main/setup.sh -o setup.sh && chmod +x setup.sh && ./setup.sh
...
Для 3X-UI переходим по адресу _http://yourIPorDomain:PORT,_ где yourIPorDomain - IP-адрес вашего сервера или доменное имя, если оно у вас есть и настроено
